...
class BayesClassifier:
    ...
    def __init__(self):
        ...
        self.pos_filename: str = "positive_words.txt"
        self.neg_filename: str = "negative_words.txt"
        self.training_data_directory: str = "review 1 - 10/"
        self.neg_file_prefix: str = "review 1 - 10"
    ...
    def classify(self, text: str) -> str:
        ...
        for word in tokens:
            ...
            if word in self.pos_freqs:
                num_pos_ap += self.pos_freqs[word]
            pos_prob+= math.log(num_pos_ap/num_pos_words)

            num_neg_ap=1
            if word in self.neg_freqs:
                num_neg_ap += self.neg_freqs[word]
            neg_prob += math.log(num_neg_ap/num_neg_words)
...
if __name__ == "__main__":
   ...
   # print(f"P('love'| neg) {(b.neg_freqs['love']+1)/neg_denominator}")
    ...
    print(b.classify('Horowitz is bloody brilliant! I loved how this is some crazy mix of mystery, memoir, essay on how to write, how a tv show is created, all rolled into one.'))
    print(b.classify('Clever! Brilliant! I don’t think I will ever write a review for this author’s work without those two words included.'))
    print(b.classify('This is brillant. one of the best books I have ever read'))
    print(b.classify('I love the writign style of this author, it really comes out in this book. This novel has made it onto my top ten list'))
    
    print("\nThe following should all be negative.")
    print(b.classify('I absolutuly hate this book. Not enough plot. a waste of money and time.'))
    print(b.classify('Crapy'))
    print(b.classify('It is not a good book, so confusing'))
    print(b.classify('I’ve been postponing reading this book for a while, always put off by the plot that sounded way to John Grishammy for me. And I was right. A rating of 3.96 is waaaay, waaay higher than it should be in my opinion. I personally didn’t like how safe it felt and how much effort Horrowitz put into apologising…it’s called fiction for a reason.'))
    print(b.classify('This book is Chaotic and pretty much without a plot, not to mention it was written in such a stilted manner. Is Lagercrantz intent on destroying Larssons legacy?'))
    print(b.classify('Absolutely pathetic. Clumsy, dull, slow. It has unbelievable characters, improbable situations, implausible plotting. '))
